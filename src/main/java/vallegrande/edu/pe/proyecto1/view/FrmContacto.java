...
import vallegrande.edu.pe.proyecto1.controller.ContactoController;

import javax.swing.*;
import javax.swing.table.JTableHeader;
import java.awt.*;

public class FrmContacto extends JFrame {

    // ================= CAMPOS =================
    public JTextField txtNombre = new JTextField();
    public JTextField txtCorreo = new JTextField();
    public JTextField txtTelefono = new JTextField();
    public JTextArea txtMensaje = new JTextArea();
    ...
    public FrmContacto() {
        ...
        setTitle("AGREIMA - GESTIÓN DE CONTACTOS");
        ...
        JLabel titulo = new JLabel("AGREIMA - GESTIÓN DE CONTACTOS");
        ...
        JLabel subtitulo = new JLabel("Formulario de Contacto");
        ...
        form.add(label("Mensaje"));

        txtMensaje.setLineWrap(true);

        txtMensaje.setWrapStyleWord(true);

        txtMensaje.setBackground(
                new Color(25, 5, 8)
        );

        txtMensaje.setForeground(blancoBrillo);

        txtMensaje.setCaretColor(blancoBrillo);
        ...
        txtMensaje.setBorder(
                BorderFactory.createCompoundBorder(
                        BorderFactory.createLineBorder(rojoBase),
                        BorderFactory.createEmptyBorder(
                                10,
                                12,
                                10,
        ...
        JScrollPane area = new JScrollPane(txtMensaje);
        ...
        return new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                GradientPaint borde = new GradientPaint(
                        0,
                        0,
                        new Color(250, 0, 21, alpha),
                        getWidth(),
                        getHeight(),
                        new Color(158, 0, 14, alpha)
                );
